...
/* H + n -> g + H2 */
	if(T9<1.5) f[12]=44060.*(1.-2.7503695564153143*T9-3.5220409333117897*T9*T9-0.2093513619089196*T9*T9*T9+0.10659679579058313*sqrt(T9)+ 4.62948586627009*pow(T9,3./2.) +1.3459574632779876*pow(T9,5./2.));
	else
f[12]=(1.-sqrt(T9)*0.8504+T9*0.4895-pow(T9,1.5)*0.09623+T9*0.008471*T9-T9*2.8e-4*pow(T9,1.5))*47420.;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<1.5) ferrlow[12]=-(67.95212182165885*sqrt(1.255364135304537+618.8966688079934*T9+21793.605102078516*T9*T9+97573.42092925594*T9*T9*T9+85539.62453206794*pow(T9,4.)+14687.125326371255*pow(T9,5.)+247.57751149254238*pow(T9,6.)-2855.9302137640752*pow(T9,11./2.)-25.82889427679147*pow(T9,1./2.)-5043.279674275595*pow(T9,3./2.)-57307.155278753264*pow(T9,5./2.)-111071.90152148822*pow(T9,7./2.)-44154.571125115704*pow(T9,9./2.)))/f[12];
...
/* Be7 + n -> p + Li7 */
	if(T9<2.5) f[17]=6.8423032e9+1.7674863e10*T9+2.6622006e9*T9*T9-3.3561608e8*T9*T9*T9-5.9309139e6*pow(T9,4.)-1.4987996e10*sqrt(T9)-1.0576906e10*pow(T9,3./2.)+2.7447598e8*pow(T9,5./2.)+7.6425157e7*pow(T9,7./2.)-2.282944e7*pow(T9,-3./2.)/exp(0.050351813/T9);
	else f[17]=1.28039e9;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<2.5)
...
/* H2 + p -> g + He3 */	
	if (T9<4.) f[20]=((-15.709674-721.9142*T9+173.23945*T9*T9-77.371692*T9*T9*T9+126.82087e0*pow(T9,1./3.)-206.50853*pow(T9,2./3.)+2120.7339*pow(T9,4./3.)-369.61306*pow(T9,5./3.)+127.8378*pow(T9,7./3.)+100.68769*pow(T9,8./3.))*pow(T9,-2./3.))/exp(1.29042942e0*pow(T9,-1./3.));
	else f[20]=2049.72;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<4.)
		{
			ferrhigh[20]=sqrt(0.02235*0.02235+1.2*pow((((-20.607762-651.42468*T9+690.01011*T9*T9-28.933696*T9*T9*T9+134.27673*pow(T9,1./3.)-148.86271*pow(T9,2./3.)+1513.5632*pow(T9,4./3.)-668.14865*pow(T9,5./3.)-11.831976*pow(T9,7./3.)-1.7647978*pow(T9,8./3.))*pow(T9,-2./3.))/exp(0.82258711*pow(T9,-1./3.)))/f[20]-1.,2.));
			ferrlow[20]=-sqrt(0.02235*0.02235+1.2*pow((((-10.782957+32828.304*T9-65943.049*T9*T9+679.86033*T9*T9*T9+727.88161*pow(T9,1./3.)-7736.0309*pow(T9,2./3.)-64848.454*pow(T9,4./3.)+84983.958*pow(T9,5./3.)+30784.918*pow(T9,7./3.)-7555.1171*pow(T9,8./3.))*pow(T9,-2./3.))/exp(2.44792659*pow(T9,-1./3.)))/f[20]-1.,2.));
		}
		else
		{
...
/* H3 + p -> g + He4 */	f[21]=pow(T9,-2./3.)*2.2e4*exp(-3.869/pow(T9,1./3.))*(pow(T9,1./3.)*0.108+1.+pow(T9,2./3.)*1.68+T9*1.26+pow(T9,4./3.)*0.551+pow(T9,5./3.)*1.06);
	if((err!=0)&&(err!=-10000))
	{
		ferrhigh[21]=0.2;
		ferrlow[21]=-0.2;
...
/* Li6 + p -> a + He3 */
	if (T9<2.5) f[23]=((-7.4966212e7-1.9411561e10*T9+1.6262854e10*T9*T9+2.0533495e7*pow(T9,1./3.)+3.9547491e9*pow(T9,2./3.)+3.7907358e10*pow(T9,4./3.)-3.4313768e10*pow(T9,5./3.)-3.9965228e9*pow(T9,7./3.)+4.0333873e8*pow(T9,8./3.))*pow(T9,-2./3.))/exp(4.62619323*pow(T9,-1./3.));
	else f[23]=3.05102e7;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<2.5)
...
/* H3 + a -> g + Li7 */
	if (T9<2.5) f[26]=((0.094614248-4.9273133*T9+99.358965*T9*T9-989.81236*T9*T9*T9+4368.45*pow(T9,4.)+931.93597*pow(T9,5.)-391.07855*pow(T9,6.)+159.23101*pow(T9,7.)-34.407594*pow(T9,8.)+3.3919004*pow(T9,9.)+0.017556217*pow(T9,10.)-0.036253427*pow(T9,11.)+0.0031118827*pow(T9,12.)-0.00008714468*pow(T9,13.))*pow(T9,-1./2.))/(exp(8.4e-7*T9)*pow(1.+1.78616593*T9,3.));
	else f[26]=807.406;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<2.5)
...
/* H2 + H2 -> n + He3 */
	if(T9<4.) f[28]=((-1.8436156e6 - 6.1150115e7*T9 - 2.7251853e7*T9*T9 - 2.2800422e6*T9*T9*T9 - 252433.58*pow(T9,4.) - 284357.41*pow(T9,10./3.) + 906146.25*pow(T9,11./3.) + 1.2270083e7*pow(T9,1./3.) - 1.3680884e7*pow(T9,2./3.) + 1.328894e8*pow(T9,4./3.) - 1.1916242e7*pow(T9,5./3.) + 8.3705218e6*pow(T9,7./3.) + 2.2357751e6*pow(T9,8./3.))*pow(T9,-2./3.))/exp(1.*pow(T9,-1./3.));
	else f[28]=4.98099e7;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<4.)
		{
			ferrhigh[28]=sqrt(0.01*0.01+13.8*pow((((-1.7643388e6-6.0708618e7*T9-2.9398403e7*T9*T9-1.6035942e6*T9*T9*T9-188921.3*pow(T9,4.)-345931.36*pow(T9,10./3.)+684862.04*pow(T9,11./3.)+1.1654271e7*pow(T9,1./3.)-1.2269338e7*pow(T9,2./3.)+1.26615e8*pow(T9,4./3.)-3.5412041e6*pow(T9,5./3.)+6.1432859e6*pow(T9,7./3.)+2.8526453e6*pow(T9,8./3.))*pow(T9,-2./3.))/exp(pow(T9,-1./3.)))/f[28]-1.,2.));
			ferrlow[28]=-sqrt(0.01*0.01+13.8*pow((((-1.7643388e6-6.0708618e7*T9-2.9398403e7*T9*T9-1.6035942e6*T9*T9*T9-188921.3*pow(T9,4.)-345931.36*pow(T9,10./3.)+684862.04*pow(T9,11./3.)+1.1654271e7*pow(T9,1./3.)-1.2269338e7*pow(T9,2./3.)+1.26615e8*pow(T9,4./3.)-3.5412041e6*pow(T9,5./3.)+6.1432859e6*pow(T9,7./3.)+2.8526453e6*pow(T9,8./3.))*pow(T9,-2./3.))/exp(pow(T9,-1./3.)))/f[28]-1.,2.));
		}
		else
		{
...
/* H2 + H2 -> p + H3 */
	if(T9<4.) f[29]=((-5.8523126e6+2.3222535e8*T9-9.877862e6*T9*T9+5.2331507e7*pow(T9,1./3.)-1.7022642e8*pow(T9,2./3.)-1.1875268e8*pow(T9,4./3.)+5.2922232e7*pow(T9,5./3.))*pow(T9,-2./3.))/exp(1.0676573*pow(T9,-1./3.));
	else f[29]=4.021e7;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<4.)
		{
			ferrhigh[29]=sqrt(0.01*0.01+12.3*pow((((-5.7455947e6+2.2299893e8*T9-9.5242666e6*T9*T9+5.1106128e7*pow(T9,1./3.)-1.651035e8*pow(T9,2./3.)-1.1215042e8*pow(T9,4./3.)+5.0522037e7*pow(T9,5./3.))*pow(T9,-2./3.))/exp(1.04599646*pow(T9,-1./3.)))/f[29]-1.,2.));
			ferrlow[29]=-sqrt(0.01*0.01+12.3*pow((((-5.8975937e6+2.3572024e8*T9-1.0002957e7*T9*T9+5.2820931e7*pow(T9,1./3.)-1.7219803e8*pow(T9,2./3.)-1.2126621e8*pow(T9,4./3.)+5.3809211e7*pow(T9,5./3.))*pow(T9,-2./3.))/exp(1.07535853*pow(T9,-1./3.)))/f[29]-1.,2.));
		}
		else
		{
...
/* H3 + H2 -> n + He4 */
	if(T9<2.5) f[30]=6.2265733e8/(exp(0.49711597/T9)*pow(T9,0.56785403)) + exp(-0.23309803*T9*T9 - 1.342742*pow(T9,-1./3.))*(-8.1144927e7 + 2.2315324e9*T9 - 2.9439669e9*T9*T9 + 1.8764462e9*T9*T9 - 6.0511612e8*pow(T9,4.) + 9.5196576e7*pow(T9,5.) - 5.2901086e6*pow(T9,6.))*pow(T9,-2./3.);
	else f[30]=3.40249e8;
	if((err!=0)&&(err!=-10000))
	{
		if(T9<2.5)
...
/* Li7 + H2 -> n + a + He4 */
	if (T9<2.5) f[33]=1.66e11*pow(T9,-2./3.)*exp(-10.254/pow(T9,1./3.))+ 1.71e6*pow(T9,-3./2.)*exp(-3.246/T9)  + 1.49e10*pow(T9,-3./2.)*exp(-4.0894/T9)* (2.57e-2/T9 + 2.6314*pow(T9,-2./3.)-4.1929/pow(T9,1./3.) -2.1241+4.1136*pow(T9,1./3.));
	else f[33]=1.37518e9;
	if((err!=0)&&(err!=-10000))
	{
		ferrhigh[33]=0.5;
...
/* Li7 + n -> g + Li8 */
	f[35]=3.144e3+4.26e3*pow(T9,-3./2.)*exp(-2.576/T9);
	if((err!=0)&&(err!=-10000))
	{
		ferrhigh[35]=0.3;
		ferrlow[35]=-0.3;
...
/* B11 + n -> g + B12 */
	f[37]=pow(T9,-1.5)*2400.*exp(-0.223/T9)+729.;

/* C11 + n -> p + B11 */
	f[38]=(1.-sqrt(T9)*0.048+T9*0.01)*1.69e8;

/* B10 + n -> a + Li7 */
	f[39]=2.2e7*(1.+1.064*T9);
	if((err!=0)&&(err!=-10000))
	{
		ferrlow[39]=-0.10794+2.2003e-2*T9-3.51236e-3*T9*T9;
		ferrhigh[39]=-ferrlow[39];
		ferr[39]=ferrlow[39];
	}
	
/* Be7 + p -> g + B8 */

	f[40]=2.61e5*pow(T9,-2./3.)*exp(-10.264/pow(T9,1./3.))*(1.-5.11e-2*T9+ 4.68e-2*T9*T9-6.6e-3*T9*T9*T9+3.12e-4*T9*T9*T9*T9)+ 2.05e3*pow(T9,-3./2.)*exp(-7.345/T9);
	if((err!=0)&&(err!=-10000))
	{
		ferrhigh[40]=0.15;
		ferrlow[40]=-0.15;
...
/* Be9 + p -> g + B10 */
	...
	f[41]=pow(T9,-2./3.)*1.33e7*exp(-10.359/pow(T9,1./3.)-T9/0.846*T9/0.846)*(pow(T9,1./3.)*0.04+1.+pow(T9,2./3.)*1.52+T9*0.428+pow(T9,4./3.)*2.15+pow(T9,5./3.)*1.54)+pow(T9,-1.5)*96400.*exp(-3.445/T9)+pow(T9,-1.5)*2.72e6*exp(-10.62/T9);

/* B10 + p -> g + C11 */
	f[42]=pow(T9,-2./3.)*1.68e6*exp(-pow(T9,-1./3.)*12.064)/(pow(pow(T9,2./3.)-0.0273,2.)+4.69e-4)*(1.+0.977*T9+1.87*T9*T9-0.272*T9*T9*T9+0.013*T9*T9*T9*T9); 

/* B11 + p -> g + C12 */
	f[43]=pow(T9,-2./3.)*4.58e7*exp(-pow(T9,-1./3.)*12.097-pow(T9/0.6,2.))*(1.+0.353*T9-0.842*T9*T9)+pow(T9,-3./2.)*6.82e3*exp(-1.738/T9)+2.8e4*pow(T9,0.104)*exp(-3.892/T9); 
	
/* C11 + p -> g + N12 */
		f[44]=pow(T9,-2./3.)*42400.*exp(-13.658/pow(T9,1./3.)-T9/1.627*T9/1.627)*(pow(T9,1./3.)*0.031+1.+pow(T9,2./3.)*3.11+T9*0.665+pow(T9,4./3.)*4.61+pow(T9,5./3.)*2.5)+pow(T9,-1.5)*8840.*exp(-7.021/T9);
	
/* B12 + p -> n + C12 */
	f[45]=pow(T9,-2./3.)*4.02e11*exp(-12.12/pow(T9,1./3.));
	ferr[45]=0.3;
	
/* Be9 + p -> a + Li6 */
	f[46]=2.11e11*pow(T9,-2./3.)*exp(-10.361/pow(T9,1./3.)-pow(T9/0.4,2.))*(1.-0.189*T9+3.52e1*T9*T9)+5.24e8*pow(T9,-3./2.)*exp(-3.446/T9)+4.65e8*exp(-4.396/T9)/(pow(T9,0.293));
	if((err!=0)&&(err!=-10000))
	{
		ferrhigh[46]=9.849e-2+0.9084*exp(-20.*T9)+1.21e-2*T9-5.987e-4*T9*T9;
		ferrlow[46]=-0.15236-0.676965*exp(-20.*T9)+0.13113*T9*exp(-T9);
		ferr[46]=ferrlow[46];
	}

/* B10 + p -> a + Be7 */
	if(T9>0.8) f[47]=1.01e10*pow(T9,-2./3.)*exp(-12.064/pow(T9,1./3.))*(-1.+15.8*T9-2.6*T9*T9+0.125*T9*T9*T9);
	else f[47]= 2.56e10*pow(T9,-2./3.)*exp(-12.064/pow(T9,1./3.))*(1.+5.95*T9+2.92e1*T9*T9-3.16e2*T9*T9*T9+9.14e2*pow(T9,4.)-1.085e3*pow(T9,5.)+4.65e2*pow(T9,6.))/(4.7e-4+pow(pow(T9,2./3.)-2.6e-2,2.));
	if((err!=0)&&(err!=-10000))
	{
		ferrlow[47]=-0.101-0.1234*T9+1.418e-2*T9*T9-5.79e-4*T9*T9*T9;
		ferrhigh[47]=-ferrlow[47];
		ferr[47]=ferrlow[47];
	}
	//f[47]=0.;

/* B12 + p -> a + Be9 */
	f[48]=pow(T9,-2./3.)*2.01e11*exp(-12.12/pow(T9,1./3.));
	ferr[48]=0.3;
	
/* Li6 + a -> g + B10 */
	f[49]=pow(T9,-2./3.)*4.06e6*exp(-18.79/pow(T9,1./3.)-T9/1.326*T9/1.326)*(pow(T9,1./3.)*0.022+1.+pow(T9,2./3.)*1.54+T9*0.239+pow(T9,4./3.)*2.2+pow(T9,5./3.)*0.869)+pow(T9,-1.5)*1910.*exp(-3.484/T9)+10100./T9*exp(-7.269/T9);
	if((err!=0)&&(err!=-10000))
	{
		ferrhigh[49]=1.;
		ferrlow[49]=-0.5;
...
/* C13 + a -> n + O16 */
	if(T9>4.) f[88]= 7.59e6*pow(T9,1.078)*exp(-12.056/T9);
	else f[88]= 3.78e14/T9/T9*exp(-32.333*pow(T9,-1./3.)-pow(T9/0.71,2.))*(1.+4.68e1*T9-2.92e2*T9*T9+7.38e2*T9*T9*T9)+2.3e7*pow(T9,0.45)*exp(-13.03/T9);
	f[88]*=(1.+7.3318e1*exp(-58.176/T9-1.98e-1*T9));

/* S reactions added RG 2018 below: */
/*
	int idxr=0; 
	int key=-1;
	...
	for (idxr=0;idxr<241;idxr++)
        {
		if(abs(sigmav_be[idxr][0]-T9)<tolerance) 
		{
			key=idxr;
			break;
		}
	...
	if(key==-1){
		f[89]=0.;
        	...
        	f[89]=paramrelic.As_heavy*sigmav_be[key][1];
	}
	...
	for (idxr=0;idxr<241;idxr++)
	{
                if(abs(sigmav_li[idxr][0]-T9)<tolerance)
                {
                        key=idxr;
                        break;
                }
        ...
        if(key==-1){
                ...
                f[90]=paramrelic.As_heavy*sigmav_li[key][1];
        }

*/
	if ((T9<2.0)&&(T9>0.1)){
		f[89]=paramrelic.AsBe7*pow(10,(270.2381815497686 - 278.9463261740185/exp(0.026293423817471063*T9))/pow(T9,0.9659522001838662));
		f[90]=paramrelic.AsLi7;
		f[91]=paramrelic.AsHe4;
		f[92]=paramrelic.AsHe3*pow(10,(291.21185485811816 - 314.92148383553604/exp(0.004874848583242346*T9))/pow(T9,0.9803534068708676));
		f[93]=paramrelic.AsH3;
		f[94]=paramrelic.AsD;
		f[95]=paramrelic.AsLi6*pow(10,(-2.2150612935016882 + 2.142003721271898/exp(3.9578660403495074*T9))/pow(T9,1.7820216601397127));
	}
	else {
		for (ie=89;ie<=95;ie++) f[ie]=0.;
	}
