...
{
	paramrelic->eta0=6.09e-10; /* baryon-to-photon ratio from WMAP */
	paramrelic->life_neutron=880.2; /* neutron lifetime PDG2016 */
	...
	paramrelic->AsBe7=AsBe7;
	paramrelic->AsLi7=AsLi7;
	paramrelic->AsHe4=AsHe4;
	paramrelic->AsHe3=AsHe3;
	paramrelic->AsH3=AsH3;
	paramrelic->AsD=AsD;
	paramrelic->AsLi6=AsLi6;
